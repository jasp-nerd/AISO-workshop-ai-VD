...
search_agent = llm_agent.Agent(
    ...
    instruction=(
        ...
        "- ALWAYS use the search_term parameter of fetch_webpage for large pages like changelogs "
        "or documentation — pass a keyword that will appear near the answer "
        "(e.g. search_term='bug fix' for a bug-fix question). "
        "Pass search_term=\"\" only for short pages where you need full content.\n"
        "- If the first page doesn't contain the answer, try another URL or rephrase the query.\n"
